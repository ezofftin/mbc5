...
<div class="container mt-5 mb-5 p-50">
	...
	<div class="vehiclesTable">
		...
		<tr>
			...
			<td><a href="<c:url value="https://naver.me/GZAwWLyg"/>" target="blank" style="text-decoration:none; color:#f96cbf">제주라인스쿠터</a></td>	
		...
		<tr>
			...
			<td><a href="<c:url value="https://naver.me/xAtWfaUM"/>" target="blank" style="text-decoration:none; color:#f96cbf">제주힐링스쿠터</a></td>		
		...
		<tr>
			...
			<td><a href="<c:url value="https://naver.me/xB4hOU5L"/>" target="blank" style="text-decoration:none; color:#f96cbf">준바이크</a></td>	
			<td>064-702-5542</td>		
		...
		<tr>
			...
			<td><a href="<c:url value="https://naver.me/5s973ZDP"/>" target="blank" style="text-decoration:none; color:#f96cbf">바이크제주</a></td>
