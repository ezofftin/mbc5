...
<div class="container mt-5 mb-5 p-50">
	...
	<div class="vehiclesTable">
		...
		<tr>
			...
			<td><a href="<c:url value="https://jejurentcar.co.kr"/>" target="blank" style="text-decoration:none; color:#f96cbf">제주렌터카</a></td>	
			<td>1588-3301</td>		
		...
		<tr>
			...
			<td><a href="<c:url value="https://www.jejurobot.com"/>" target="blank" style="text-decoration:none; color:#f96cbf">로보트렌터카</a></td>		
		...
		<tr>
			...
			<td><a href="<c:url value="https://homepage.skcarrental.com"/>" target="blank" style="text-decoration:none; color:#f96cbf">SK렌터카</a></td>	
			<td>1599-9111</td>		
			<td>평일 09:00~18:00</td>
		...
		<tr>
			...
			<td><a href="<c:url value="https://www.lotterentacar.net/"/>" target="blank" style="text-decoration:none; color:#f96cbf">롯데렌터카</a></td>
			<td>064-751-8000</td>		
