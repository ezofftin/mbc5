...
<%@ include file="../admin/ad_header.jsp" %> <!-- 헤더 파일 포함 -->
        ...
        <tbody>
            <c:forEach var="dto" items="${list}"> <!-- model 속성 list를 사용 -->
                <tr>
                    ...
                    <td>${dto.hit}</td>
                    <td>
                        <button class='btn btn-danger btn-sm' onclick="delBoard(${dto.bid}, ${pDto.viewPage}, '${pDto.searchType}', '${pDto.keyword}', ${pDto.cntPerPage})">삭제</button>
                    </td>
                </tr>
            </c:forEach>
